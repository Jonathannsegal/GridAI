...
def plot_loss(history):
  ...
  plt.legend()
  plt.grid(True)
  plt.savefig('Loss_SinglePhase_Secondary.png')
...
fp = ('/home/ubuntu/Documents/sdmay21-23/Hello_World_Projects/pwenzel/api/SinglePhase_Secondary.csv')
...
linear_model.save('SinglePhaseSecondaryModel')
plot_loss(history)
...
plt.savefig('SinglePhase_Secondary.png')