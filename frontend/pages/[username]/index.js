...
export default function UserProfilePage({ user }) {
  ...
  //   console.log("we have a successful return from 'getAllNodes()'");
  //   console.log("inside result = ", result);
  //   nodes = result;
  // }).catch(err => {
  //   console.log("we have an error return from 'getAllNodes()'");
  //   return(<main><div><p>Sad, we got an err</p></div></main>)
  // }
  // )
